...
## CURRENT OVERRIDE — iter81, 2026-09-15
...
If iter81 also cap-fails at the same position, the next controlled endpoint is
`PRODUCTION_EXCHANGE_LEDGER` **2 GiB → 1 GiB** — the only remaining lever inside
the binding region, and the 1 GiB setting has a completion receipt on record
(`4bb9bdd2`, PR #715).
