...
Submission candidate. The exact source passed the official build, purity,
license, permutation, determinism, timeout, and full 300-matrix development
corpus path. It scores `0.848766` with fill tiebreak `0.947446`, compared with
the promoted frontier's public score of `0.848955`.
