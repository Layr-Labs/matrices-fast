...
- **Status:** LOCAL WIN, **HIDDEN FAIL** (submission `71f76302`, 2026-09-05). No hidden score — the 2 s cap. A second `subtree_refine` on first-round misses is closed. See [0065](0065-widen-existing-leftover-max-s.md).
