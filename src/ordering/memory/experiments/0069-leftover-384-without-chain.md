...
- **Status:** LOCAL WIN vs tip. Skip-all-chain draft scored **0.843421** (worse than tip): `pooling_sppa9tp` stayed 0.4464, so the 0.4090 basin is in the chain after leftover-384. Revised leftover-384 + rounds 2–3, skip rounds 4–5: `pooling_sppa9tp` 0.4464→0.4410, `pooling_sppa9pq` 0.6473→0.6302, worst `order()` 1.359 s.
