...
- **Status:** LOCAL WIN, **HIDDEN FAIL** (submission `194629f`, 2026-09-05). No hidden score — the 2 s cap. The hidden occupant is in the pooling band. Leftover-384 + full chain there is closed. See [0071](0071-leftover-384-band-cheap-chain.md).
