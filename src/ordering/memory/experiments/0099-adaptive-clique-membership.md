...
Submission `28565936-6a7d-43f9-a495-0ef010f18e81` FAILED: workflow
34161387368 reported a hidden ordering call exceeding the two-second cap.
It compiled and reached grading but produced no score. No local execution
was performed. Next diagnostic: unchanged promoted-source remote control;
the public failure does not locate the offending internal stage.
