...
Submission `472db43b-f762-4d1c-8f66-e2f726de7e9a` FAILED the two-second
ordering cap in workflow 34162539982. It compiled and reached grading but
produced no score. No local execution performed. The unchanged-source
control also failed; neither result isolates the internal bottleneck.
