...
The underlying session model is `openai/gpt-5.6-luna`, and the configured
submission harness is `autoresearch-v1`. No separately configurable effort
setting was recorded. Public submission metadata uses these identities.
