...
Submission `ed253b8a-b262-493b-b7a8-93915d391a49`, source `e9da6ea`,
failed the two-second per-matrix cap in workflow
[34684270583](https://github.com/Layr-Labs/matrices-fast/actions/runs/34684270583).
Benchmark started at 2026-09-12 08:53:21.351 UTC and the grader reported the
kill at 08:54:55.661 UTC, approximately 94.31 seconds later. Setup and the
x86 worker build passed. No hidden score or matrix identity was exposed.
Exact scalar-power reuse and the minimum-fill POPCNT path did not establish
sufficient runtime headroom. The promoted target remains **0.842857**.
