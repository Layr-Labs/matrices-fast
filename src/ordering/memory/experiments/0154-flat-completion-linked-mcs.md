...
failed the hidden two-second per-matrix cap in workflow
[34685112302](https://github.com/Layr-Labs/matrices-fast/actions/runs/34685112302).
Benchmark started at 2026-09-12 09:13:26.643 UTC and the cap kill was reported
at 09:15:01.293 UTC, approximately 94.65 seconds later. No hidden score was
produced. Flat reconstruction and exact linked MCS remain useful measured
kernels, but did not establish enough whole-pipeline margin on this run.
The target remains **0.842857**.
