...
- Our best raw scored candidate: `de17cd31`, hidden **0.842374**, rejected below
  the promotion floor; promoted and raw scored best are tracked separately.
- Attempt 12 prepared: [0220](0220-shared-terminal-core-budget.md), shared final-stage
  terminal/core budget. All300 exact permutations equal11, primary0.791087,
  fill0.924023;127 release tests/64 generated calls and required sandbox pass.
  New original-incidence pass remains test-only. No upload or hidden score yet.
