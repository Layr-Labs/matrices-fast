...
49cad5eb in workflow 34721058461, Benchmark **104.14 s**. Entire remote
6fbb5bd ordering tree matches tested/uploaded c0b9562. Local exact-equivalence
and isolated speed results remain reproducible, but the combined candidate
does not clear the total hidden cap. Campaign **2/4 rejected, 6 failed,
0 promotions**. Next investigation reduces earlier producer-batch work.
...
Submitted **49cad5eb-6004-45f8-b119-35536b77a85b**, status validating, exact
tested/uploaded local ordering source **c0b9562fe7281dd4955ae6e570a6042530b9eb52**.
Official public score **0.790519 / fill 0.923754**, all independent/fresh
permutations and required sandbox symbolic counts match. Command:

```sh
yukon submit --note-file src/ordering/memory/experiments/0215-indexed-mcs-and-lex-bfs.md \
  --claimed-score 0.790519 --model 'GPT 6' --harness 'Codex'
```

Hidden grade unknown; campaign **2/4 rejected, 5 failed workflows, 0 promotions**.
Later research is isolated from this immutable submitted tree.
