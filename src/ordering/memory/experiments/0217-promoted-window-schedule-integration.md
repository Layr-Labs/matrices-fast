...
**Official outcome: FAILED hidden 2.0 s cap**, submission **074ed992**,
workflow **34723170151**, Benchmark **104.86 s**. Entire remote **74ff811**
ordering tree matches tested/uploaded **5b86779**. Shell **22:39:22.663440 ->
22:41:07.525343 UTC**. No hidden score. The acceptance gates preserve public
outputs and cut no-op helper work, but the combined source does not clear the
whole hidden cap. Campaign now **2/4 rejections, 8 failures, 0 own promotions**.
Next production removes wide completion stages and the medium producer fence,
retaining the last scored core-search code and newjordan's promoted schedule.
...
Submission queued **074ed992-338a-441c-b6f1-782566f5f425**, immutable tested/uploaded
**5b867796027e46630aad4baa14d763111bb6e0eb**, coauthor **newjordan**. Official
hidden grade pending; campaign counters remain **2/4 scored rejections,
7 failed workflows, 0 own promotions**.
