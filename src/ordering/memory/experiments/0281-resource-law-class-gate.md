...
- **Status:** **submitted and rejected** as `0e1edc92`: hidden `0.840512` versus
  promoted `0.840511`, so it missed strict promotion by `1e-6`. The companion
  union-table "optimisation" is a **verified negative** and is not shipped.
