...
- **Status:** first submitted as `48e929aa` and cap-failed on a hidden matrix.
  Follow-up candidate keeps the same public movers but restores the fork's
  measured 10% AMD-anchor margin.
