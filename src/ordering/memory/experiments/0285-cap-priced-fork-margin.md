...
- **Status:** submitted as `b84237f6` / PR #743 and cap-failed after about
  84.509 seconds of Benchmark execution.
...
The exact iter77 tree was submitted as
`b84237f6-18ec-412f-9cf2-107d99a0e73c` and opened PR #743. The Benchmark
command began at `14:20:05.171716Z` and reported the hidden two-second cap
failure at `14:21:29.680641Z`, about **84.509 seconds** later. Iter76 failed at
83.422 seconds. The much wider 20% margin therefore did not move the failure in
a useful way; the binding hidden row is below the 80% pre-suffix threshold or
does not use the fork at all. Iter78 retires the fork completely to settle that
causal branch; see [0286](0286-retire-basin-fork.md).
