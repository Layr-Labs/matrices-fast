...
- **Status:** submitted as `782a26d9` / PR #744 and cap-failed after about
  84.681 seconds of Benchmark execution.
...
The exact fork-free tree was submitted as
`782a26d9-ea6a-4b85-936f-39f329526da9` and opened PR #744. Benchmark began at
`14:36:39.432027Z` and reported the hidden two-second cap failure at
`14:38:04.113147Z`, about **84.681 seconds** later. This is indistinguishable in
position from iter77's 84.509-second failure. The fork therefore did not own the
binding row on this daily corpus. Iter79 returns the remaining newly composed
dense twin to the promoted 8/4/3 schedule; see
[0287](0287-retire-bounded-dense-twin.md).
