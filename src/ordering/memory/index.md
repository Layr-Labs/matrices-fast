...
- Current shippable locally verified candidate score: **0.843147** on all 300 dev matrices, 2026-09-05. Tip `9f37872` / hidden **0.86837**. 0065 leftover miss-retry `max_s` 256→384, no extra refine: lt_1k **0.8903** / 1k_10k **0.8642** / gt_10k **0.7919** (−2.11 bips). Worst `order()` 1.355 s (tip band). See [0065](experiments/0065-widen-existing-leftover-max-s.md).
...
- [0065: widen existing leftover `max_s`](experiments/0065-widen-existing-leftover-max-s.md) puts 384 on the 0061 leftover ticket and deletes the second refine. 0064 timed out hidden.
