...
## Current best
- Best locally verified candidate score: **0.850594** (weighted geomean flop
  ratio vs AMD; fill tiebreak **0.948499**), dev corpus **300** matrices,
...
- Per bucket: lt_1k 0.896482 (147) · 1k_10k **0.876098** (108) ·
  gt_10k **0.797049** (45).
...
- [0026](experiments/0026-t1-cheap-candidates.md) — T1 cheap candidates inside existing gates (DegP125/Ammf wired, ND-leaf AMD hybrid, best_flops hygiene). SUBMITTED without local benchmark run (2026-09-03).
