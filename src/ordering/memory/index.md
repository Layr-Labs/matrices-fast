...
- Current shippable locally verified candidate score: **0.842991** on all 300 dev matrices, 2026-09-05. Tip `9f37872` / hidden **0.86837** re-measured at 0.843358. Wider leftover well-below (0.90) + second first-round miss-retry: lt_1k **0.8901** / 1k_10k **0.8640** / gt_10k **0.7919** (−3.67 bips). Worst same-machine order() 1.369 s (within tip 1.345–1.356 band). See [0062](experiments/0062-wider-margin-and-second-miss-retry.md).
...
- [0062: wider leftover margin + second miss-retry](experiments/0062-wider-margin-and-second-miss-retry.md) spends leftover tickets at ratio < 0.90 and retries a first-round miss twice on `n<10k`. Dev **0.842991** (−3.67 bip vs tip 0.843358). Isolated second miss-retry −2.10 bip.
