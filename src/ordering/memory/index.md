...
## Current best
- Best score: **0.851513** (weighted geomean flop ratio vs AMD; fill tiebreak
  **0.949215**), dev corpus **300** matrices, 2026-09-02
  ([0021](experiments/0021-exact-subtree-refinement.md), bounded exact search
  over disjoint elimination-tree subtrees). Previous local best: 0.859116 / fill
  0.955319; previous promoted hidden score: 0.880467.
- Per bucket: lt_1k 0.896482 (147) · 1k_10k **0.877695** (108) ·
  gt_10k **0.798150** (45).
...
- **Timing headroom is the binding constraint,** but noisier than earlier pages
  ...
  The 0021 final probe measured **0.801 s**, still inside that accepted range.
...
- [0021](experiments/0021-exact-subtree-refinement.md) — Exact search over at most 32 ranked, disjoint elimination-tree subtrees with two fixed streams. 0.859116 → **0.851513**. WIN.
