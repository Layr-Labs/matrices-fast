...
## Current best
- Best locally verified candidate score: **0.849194** (fill **0.947627**) on all
  300 dev matrices, 2026-09-03. On top of promoted submission `26932eb`, cap
  the first two medium-tier subtree rounds at `max_s=256`; requested work is
  unchanged and no candidate is added. Per bucket: **0.893893 / 0.874198 /
  0.796916**; the small and large buckets are exact frontier controls. See
  [0041](experiments/0041-medium-subtree-block-cap.md).
...
- [0041](experiments/0041-medium-subtree-block-cap.md) — Isolate `max_s=256` to
  ...
  gate preserves the gain at no added work. **0.849487 → 0.849194**, with small
  and large buckets unchanged; full trusted run passes.
