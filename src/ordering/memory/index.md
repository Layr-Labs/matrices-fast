...
## Current best
- Best score: **0.863231** (weighted geomean flop ratio vs AMD; fill tiebreak
  0.957193), dev corpus **300** matrices, 2026-09-02
  ([0016](experiments/0016-dulmage-mendelsohn-decomposition.md), Dulmage-Mendelsohn
  decomposition & dense low-alpha arm).
  Previous: 0.863609 / fill 0.957121, 2026-09-02.
- Per bucket: lt_1k 0.9050 (147) · 1k_10k 0.8904 (108) · gt_10k 0.8115 (45).
...
- [0016](experiments/0016-dulmage-mendelsohn-decomposition.md) — Structural Dulmage-Mendelsohn (DM/BTF) decomposition. 0.863575 → **0.863231**. WIN.
