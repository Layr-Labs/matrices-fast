[0159: is a cap verdict a property of the hunk or of the base?](experiments/0159-base-dependence-of-the-cap.md):
three single-hunk arms off the tip died on the 2 s cap at 99/100/100 s while the
tip itself, resubmitted byte-identically, passed at 481 s. One of those hunks is
re-applied to the promoted frontier's code to separate the two explanations.
