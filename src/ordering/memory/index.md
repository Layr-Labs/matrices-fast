...
- [0150: equal-budget terminal window exchange](experiments/0150-equal-budget-terminal-window-exchange.md) — after 0149 also timed out, replace the promoted width-12/32M union pass with width-8/32M signature search; keep the hidden-proven **136M** total allowance and improve dev to **0.792188**, with a 0.727 s measured worst call.
