...
- Current shippable locally verified candidate score: **0.843226** (fill **0.943186**) on all 300 dev matrices, 2026-09-05. Base `ea67ff8` score 0.843978. Conditional search escalation on below-anchor matrices: lt_1k **0.889858** / 1k_10k **0.865849** / gt_10k **0.791286** (−7.52 bips gain). Worst same-machine order() 1.395 s (base 1.358 s). See [0060](experiments/0060-conditional-search-escalation-below-anchor.md).
