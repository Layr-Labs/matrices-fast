[0155: small alternate-PEO envelope and linear sorted permutation](experiments/0155-small-alt-peo-linear-permutation.md):
retire the 50k alternate-seed phase above **1k**; retain incumbent PEO and
donor transplantation. Direct dev **0.792349776881**, one regression versus
0154 and 299 unchanged; still below promoted dev **0.792439173**. Paired
whole-call savings **4–14%** where the removed phase ran, 30 permutations
match on the timing sample. Linear sorted CSC matches feral on 1,200 cases;
121 active tests pass. Official sandboxed run passes all 300 at **0.792350**,
fill **0.924437**. Hidden result pending; target **0.842857**.
...
width-8/stride-3 retained. Submission `aac9f0ec` failed the hidden cap
(workflow `34685112302`, Benchmark 94.65 s); no hidden score. Target **0.842857**.
