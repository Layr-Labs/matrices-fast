...
- [0092: transplant widths + winner polish](experiments/0092-transplant-widths-winner-polish.md) — 081af15 dev 0.823737 → **0.823582** (−1.55 bips); widths 1024/64 same 250k ledger, winner-only pair/simplicial polish, tiny MinFill/streams/alphas/rounds; 69 tests, worst 0.697 s; chains/ledger-300k/sparse-large failed hidden, closed.
