...
- [0096: chained MINL + mid-α relabelled lotteries](experiments/0096-chained-minl-midalpha-lotteries.md) — d74ab4b dev 0.808268 → **0.807908** (−3.60 bips, 1k_10k + gt_10k); fresh-budget descent continuation on strict wins only, shipped-α + mid-α5 relabelled draws on disjoint streams; 71 tests, worst 0.637 s; AMF-on-M control +0.00 reverted.
