[0199: mid-band non-hub relabel floor 12→16](experiments/0199-midband-relabel-floor16.md):
74b6ccd **0.793834 → 0.793841** miss. 0/1 (mpbp_15); mid-band class 0 better. Floor reverted. Not submitted.

[0197: n>16k metric last slot DegP075 → DegP125](experiments/0197-n16k-degp075-to-degp125.md):
74b6ccd **0.793834 → 0.793834** miss. 0/1 (gabriel09); n>16k 0 better. Branch reverted. Not submitted. linson007 38a3c21 failed.

[0196: fourth metric core n>16k under (11,10); drop SqDiv](experiments/0196-fourth-metric-core-n-gt-16k.md):
74b6ccd **0.793834 → 0.793849** miss. 0/1 (pinene200); 4th-class hits tip-flat. indep_first reverted. Not submitted. DEPTHS [5,4,2,6] intact.

[0195: same-count REDUCE_EXTRA_DEPTHS last 6→7](experiments/0195-reduce-extra-depth7.md):
74b6ccd **0.793834 → 0.793834** miss. 0/0. DEPTHS reverted to [5,4,2,6]. Not submitted. mid_k2 intact.

[0194: same-count HEAVY_METRIC last ticket → extra_deg_div_nv_wf01](experiments/0194-heavy-metric-wf01.md):
74b6ccd **0.793834 → 0.793834** miss. 0/0. ticket reverted. Not submitted. dens≤4/mid closed.

[0193: same-count HEAVY_METRIC last ticket → cm_ammf](experiments/0193-heavy-metric-ammf.md):
0192-package **0.793811 → 0.793811** miss. 0/0. Ammf reverted; dens≤4 left intact. Not submitted. `268e91c` failed.

[0192: dens≤4 else-floor second seed on clean tip](experiments/0192-dens4-else-seed-on-tip.md):
74b6ccd **0.793834 -> 0.793811** keep. 2/0 (mpbp_46, rsyn0840m02m); ct3 preserved; uncapped worst 1.516s ≤ tip 1.654s. 0190 mid hole reverted. submitted `268e91c5` → **failed** (n/a). dens≤4 seed still in tree.
...
- [0200: FINAL_FIVE_OPS 128M→160M](experiments/0200-final-five-ops-160m.md) — 0.793834→0.793825 KEEP; 9/0; worst 1.442s≤1.654s; submitted.

- [0198: HEAVY cm_sqpure α5→1](experiments/0198-heavy-sqpure-alpha1.md) — slot[1] α5.0→1.0; 0.793834 tip-flat 0/0; bar missed, alpha reverted, not submitted.
