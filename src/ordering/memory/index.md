...
- Current shippable locally verified candidate score: **0.843339** (fill **0.943644**) on all 300 dev matrices, 2026-09-05. Base `c3fae01` score 0.843658. Chain-tail skip on gt_10k + below-anchor terminal escalation: lt_1k **0.8901** / 1k_10k **0.8651** / gt_10k **0.7919** (−3.19 bips). Worst `order()` 1.357 s. See [0063](experiments/0063-chain-tail-skip-plus-escalation-flops-gate.md).
