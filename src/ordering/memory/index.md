...
- [0057](experiments/0057-amf-alpha-half-and-twofive.md) — Unlabelled AMF
  α∈{0.5, 2.5} inside the existing `nnz<130k` sweep. Probe **0.845281 → 0.844348**
  (−9.33 bips); two unique wins (`crudeoil_pooling_dt2`, `chp_partload`);
  extra-pass worst +0.041 s. Not a gate widen and not a search-budget raise.
