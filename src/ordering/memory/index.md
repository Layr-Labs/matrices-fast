...
- Current shippable locally verified candidate score: **0.843148** on all 300 dev matrices, 2026-09-05. Tip `9f37872` / hidden **0.86837**. 0064 isolated second miss-retry after 0062/0063 hidden 2 s fails: lt_1k **0.8903** / 1k_10k **0.8642** / gt_10k **0.7919** (−2.10 bips). Worst `order()` 1.434 s (same noisy band as the 1.345 s tip). See [0064](experiments/0064-isolated-second-miss-retry.md).
...
- [0064: isolated second miss-retry](experiments/0064-isolated-second-miss-retry.md) reverts well-below to 0.80 and keeps only the `n<10k` second first-round miss-retry. Expected **0.843148** (−2.10 bip). 0062 and 0063 timed out hidden.
