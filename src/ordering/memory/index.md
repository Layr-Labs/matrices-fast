...
- Current shippable locally verified candidate score: **0.842991** on all 300 dev matrices, 2026-09-05. Tip `9f37872` / hidden **0.86837**. 0063 retracts 0062's 0.90 extra relabel on `n >= 10k` after hidden 2 s fail. Buckets 0.8901 / 0.8640 / 0.7919 (−3.67 bip). Worst `order()` 1.361 s. See [0063](experiments/0063-drop-large-090-extra-relabel.md).
...
- [0063: drop large-graph 0.90 extra relabel](experiments/0063-drop-large-090-extra-relabel.md) keeps 0062's miss-retry and 0.90 LNS; large extra relabel stays at the hidden-proven 0.80 gate. 0062 timed out hidden.
