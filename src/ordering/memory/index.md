...
- Current shippable candidate is still the 0061 tip: local **0.843358**, hidden **0.86837** (`c7d5fe71`). 0062–0065 and 0069 failed the hidden 2 s cap. 0070 gates leftover-384 to the pooling band. See [0070](experiments/0070-leftover-384-pooling-band.md).
- 0070 leftover-384 only on the pooling band: local **0.843148** (−2.10 bip), `pooling_sppa9tp` 0.4090, worst 1.346 s. See [0070](experiments/0070-leftover-384-pooling-band.md).
...
- [0070: leftover-384 pooling band](experiments/0070-leftover-384-pooling-band.md) keeps leftover-384 only on the two local pooling movers.
