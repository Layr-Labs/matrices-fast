...
- Current shippable locally verified candidate score: **0.838285** on all 300 dev matrices, 2026-09-05; fill **0.942538**. Eight relabelled AMF and eight relabelled AMD passes on the retained degree-three residual core, gated to `core_n <= 4000`, improve 7 matrices with 0 worse. Bucket flop geomeans **0.890341 / 0.867281 / 0.777498**; worst same-machine order() **0.841 s**. Full trusted run and 50 active tests pass. Hidden validation pending. See [0065](experiments/0065-core-relabelled-objectives.md).
- Current shippable locally verified candidate score: **0.838890** on all 300 dev matrices, 2026-09-05; fill **0.942755**. Extra final ranked-subtree round 5 (`4` blocks, `max_s=768`, 8M budget) improves 34 matrices with 0 worse on `1000 <= n <= 80000`, `nnz <= 250000`. Bucket flop geomeans **0.890341 / 0.868271 / 0.778266**; worst same-machine order() **0.947 s**. Full trusted run, 50 active tests, and synthetic probe pass. Hidden validation pending. See [0064](experiments/0064-extra-ranked-subtree-round5.md).
...
- [0064: extra ranked-subtree round 5](experiments/0064-extra-ranked-subtree-round5.md) — final strict-best pass on the completed pipeline, matching the strongest probe variant (`4` ranked blocks, `max_s=768`, 8M budget) on the measured small/medium gate. Dev **0.838890**, fill **0.942755**, 34/0 movers, worst order() **0.947 s**; hidden validation pending.
- [0065: relabelled objectives on the residual core](experiments/0065-core-relabelled-objectives.md) — eight relabelled AMF plus eight relabelled AMD passes on the exact degree-three residual core, gated to `core_n <= 4000`. Dev **0.838285**, fill **0.942538**, 7/0 movers, worst order() **0.841 s**; hidden validation pending.
