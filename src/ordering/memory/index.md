...
- Current shippable candidate is still the 0061 tip: local **0.843358**, hidden **0.86837** (`c7d5fe71`). 0062–0065 failed the hidden 2 s cap. 0066–0068 were local no-ops. 0069 restores leftover-384 without unlocking the chain. See [0069](experiments/0069-leftover-384-without-chain.md).
- 0069 leftover `max_s=384` + rounds 2–3, skip rounds 4–5 on leftover-wide: local **0.843328** (−0.30 bip vs 0.843358), worst 1.359 s. See [0069](experiments/0069-leftover-384-without-chain.md).
...
- [0069: leftover-384 without chain](experiments/0069-leftover-384-without-chain.md) restores the 0065 window and skips rounds 2–5 on leftover-wide hits.
