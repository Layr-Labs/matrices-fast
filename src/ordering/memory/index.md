[Latest residual-core revision](experiments/0076-medium-core-minfill-2000.md)
...
- [0076: medium-core residual MinFill to cn 2000](experiments/0076-medium-core-minfill-2000.md): current local candidate **0.832049** versus `0.832118`; `1k_10k` moves from `0.864765` to `0.864536`, fill from `0.938869` to `0.938855`; other buckets unchanged. Worst local `order()` `0.582 s`, unchanged. Full trusted 300-matrix run, `yukon run`, and 66 tests pass. Official validation pending.
