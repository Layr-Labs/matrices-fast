...
- [0092: transplant widths + winner polish](experiments/0092-transplant-widths-winner-polish.md) — 081af15 dev 0.823737 → **0.823574** (−1.63 bips); widths 1024/64 added under the same 250k ledger, chained 2nd/3rd on strict wins, winner-only pair/simplicial polish, tiny MinFill/streams/alphas/rounds; 69 tests, worst 0.695 s; ledger-300k variant (+2.91 locally) FAILED hidden, closed.
