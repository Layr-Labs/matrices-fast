...
- [ ] **IN FLIGHT — Leftover `max_s=384` only on the pooling band.**
      [0070](experiments/0070-leftover-384-pooling-band.md) keeps 0061 leftover-256
      on every other medium miss.
