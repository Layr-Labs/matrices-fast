        ...
        if improved > 0 && is_bijection(&candidate, n) {
            ...
            if f < incumbent_flops {
                ...
                if (n < 10_000 && nnz <= 100_000) || (n >= 10_000 && nnz <= 60_000) {
                    ...
                    cfg2.round = 6;
                    cfg2.min_s = 8;
                    cfg2.max_blocks = if (1_000..10_000).contains(&n) { 2 } else { 4 };
                    cfg2.budget = if (1_000..10_000).contains(&n) {
                        2_000_000
                    } else {
                        4_000_000
                    };
                    ...
                    if improved2 > 0 && is_bijection(&candidate2, n) {
                        ...
                        if f2 < f {
                            ...
                            cfg3.round = 7;
                            cfg3.min_s = 8;
                            cfg3.max_blocks = if (1_000..10_000).contains(&n) { 2 } else { 4 };
                            cfg3.budget = if (1_000..10_000).contains(&n) {
                                2_000_000
                            } else {
                                4_000_000
                            };
