...
const PRODUCTION_SPAN_WINDOWS: [(usize, usize, usize, i64); 17] = [
    ...
    (14, 4, 5, 64_000_000),
    (6, 4, 3, 64_000_000),
    // iter59 TEST ARM: the eight narrow widths of the `0230` schedule (measured
    // there at -3.5e-5 dev on the 9-window tree). Their per-pass replay is now
    // partly paid for by the shared kernel; this arm prices the stacked tree.
    (4, 4, 2, 64_000_000),
    (5, 4, 2, 64_000_000),
    (13, 4, 6, 64_000_000),
    (15, 4, 7, 64_000_000),
