...
fn leader_order(pattern: &Pattern) -> Vec<usize> {
    ...
    // iter1157a NEW SCORE: 1111 SCORE chassis + 1150 simplicial widen (best-WORST DNA).
   ...
   // Terminal completion cleanup leaves every existing descent seed intact.
    ...
    // iter1157a NEW SCORE: add 1103 tip windows for movers atop 1111 SCORE DNA.
    ...
    // iter1157a NEW DNA on 1094 chassis: deepen deep_small + factor-bound windows.
