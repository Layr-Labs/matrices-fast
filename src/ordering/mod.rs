...
/// Require the incumbent to be at least 10% below AMD before paying for a
/// second suffix. All measured fork movers satisfy this; the expensive
/// near-anchor non-movers do not.
