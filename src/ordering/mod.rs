...
fn leader_order(pattern: &Pattern) -> Vec<usize> {
    ...
    flush!();
    // iter565a: force METIS-var/KaHIP-multi on n<=8k ONLY — tip shape grid unchanged.
    // 562 denser grid CI-failed; 561 n<=25k timing-killed; keep chimera structural ungating.
