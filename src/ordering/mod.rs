...
fn subtree_cfg_for(n: usize, nnz: usize) -> rgreedy::SubCfg {
    ...
    if n < 1_000 {
        // Small graphs use at most the same 32M requested-work ceiling as the
        // other tiers. Sparse small patterns use four deeper blocks but stop at
        // 26.5M total work; denser patterns retain the promoted 16-by-2M shape.
        // The reduced sparse budget is required by two hidden timeout results.
        cfg.min_s = 16;
        cfg.max_s = 256;
        cfg.max_blocks = 16;
