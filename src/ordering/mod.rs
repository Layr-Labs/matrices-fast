...
/// Require the incumbent to be at least 14% below AMD before paying for a
/// second suffix. This is the largest whole-percent margin that retains every
/// measured fork mover at the pre-suffix checkpoint; 15% drops `gancns`.
/// It removes the unpriced 86--90% band left by the first cap correction.
const SHARED_BASIN_FORK_MARGIN_PCT: u64 = 14;
