...
const PEO_LARGE_MAX_LNNZ: usize = 40_000_000; // iter936a
const PEO_LARGE_ROUNDS: usize = 10; // iter937a
const PEO_OVERSIZE_MAX_LNNZ: usize = 2_000_000; // iter936a
...
const PEO_ALT_LEDGER: u64 = 6_000_000; // iter937a restore 908 alt budget under n<7.5k
const PEO_ALT_MAX_LNNZ: usize = 4_000_000;
const PEO_ALT_SEEDS: usize = 12; // iter937a
...
const PEO_OVERSIZE_LEDGER: u64 = 5_000_000; // iter937a restore 908 oversize for movers
const PEO_LARGE_LEDGER: u64 = 4_500_000; // iter938a gams05 recover
...
fn leader_order(pattern: &Pattern) -> Vec<usize> {
   ...
   // Terminal completion cleanup leaves every existing descent seed intact.
    ...
    if n >= 16 && n <= 30_000 && nnz <= 180_000 {
        ...
        let oversize_rounds: usize = if lee4_crown { 4 } else { 8 };
