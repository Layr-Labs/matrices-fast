...
//!
//! DETERMINISM. Fixed start vector (raw indices — deliberately NOT
//! orthogonal to ones, so the Krylov space contains the null direction and
//! the second-smallest Ritz value is the Fiedler value), fixed step count,
