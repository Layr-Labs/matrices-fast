...
// iter651a NEW BASE: 647 transplant-ties + LEDGER 2M; open sparse-large AMD-ties
// (facility/transswitch class at ratio≈1) that tip's below-anchor gate skips.
const TRANSPLANT_LEDGER: u64 = 2_000_000;
...
fn transplant_pass(
    ...
    'widths: for width in [4096usize, 512, 128, 32, 8] { // iter651a
