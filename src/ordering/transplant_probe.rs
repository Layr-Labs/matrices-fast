...
const TRANSPLANT_LEDGER: u64 = 400_000;
...
pub(super) fn refine_with_donors(
    ...
    // every admission still burns ledger; concentrating 400k on n>=1000
    // recovered nearly the full 400k geomean with far fewer paid rows.
    #[cfg(test)]
...
fn probe_transplant_ledger_gate_sweep() {
    ...
    let cfgs = [
        ...
        Cfg { name: "400k_3x_med+", cap: 400_000, gate_mult: 3, below_amd_only: true, min_n: 1000, max_n: usize::MAX, min_block: 4, width_mode: 0 },
        Cfg { name: "400k_3x_gt10k", cap: 400_000, gate_mult: 3, below_amd_only: true, min_n: 10000, max_n: usize::MAX, min_block: 4, width_mode: 0 },
        Cfg { name: "400k_3x_1k10k", cap: 400_000, gate_mult: 3, below_amd_only: true, min_n: 1000, max_n: 10000, min_block: 4, width_mode: 0 },
